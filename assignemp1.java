 ...
 * @author abuba
 */
public class assignemp1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"rakib", "sarkar", "01689040992", "rakibsarkar26@gmail.com", "dhaka", "Employee", "dhaka"},
                {"fahim", "muntasir", "01778908573", "fahim35-1900@diu.edu.bd", "rongpur", "Helper", "rangpur"},
                {"abu", "bakkar", "01885769220", "abu35-1994@diu.edu.bd", "Kasba,namtabad", "employee", "brahmanbaria"},
                {"nayeem", "biswas", "01778904080", "nayeemul35-1938@diu.edu.bd", "jessore", "Driver", "jessore"}
            },
            new String [] {
                "First Name", "Last Name", "Phone", "E-Mail", "Address", "Position", "District"
            }
        ));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        this.setVisible(false);
        new assignemp1().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(assignemp1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
